...
class HopefullNet(tf.keras.Model):  #Inheriting functions (tf.keras.Model)
    """
    ...
    def __init__(self, inp_shape = (640,2)):
        ...
        self.out = tf.keras.layers.Dense(2, activation='sigmoid') #(1 class)
...
if __name__ == '__main__':
    ...
    input_shape = (None, 640, 2) #None- nOExamples, nTimepoints, 2- Channels
    model.build(input_shape) # CNN.build